...
let
  ...
  redshiftModuleRefactor = fetchTarball {
    url = "https://github.com/thiagokokada/nixpkgs/archive/442efff681a10dda2032ac12dc5a1076429824cd.tar.gz";
    sha256 = "0pybcixlldkxab9n0y0mhi6hc10wihagxznpqchnpw7bifa4b921";
  };
in {
